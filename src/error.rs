...
const ISO_CONNECT: i32 = 0x00010000; // Connection error
const ISO_INVALID_PDU: i32 = 0x00030000; // Bad format
pub const ISO_INVALID_DATA_SIZE: i32 = 0x00040000; // Bad Datasize passed to send/recv : buffer is invalid

pub const CLI_NEGOTIATING_PDU: i32 = 0x00100000;
...
const CLI_CANNOT_START_PLC: i32 = 0x00E00000;
const CLI_ALREADY_RUN: i32 = 0x00F00000;
const CLI_CANNOT_STOP_PLC: i32 = 0x01000000;
const CLI_CANNOT_COPY_RAM_TO_ROM: i32 = 0x01100000;
const CLI_CANNOT_COMPRESS: i32 = 0x01200000;
const CLI_ALREADY_STOP: i32 = 0x01300000;
